...
enum ts_symbol_identifiers {
  ...
  sym_else_if_chain = 54,
  sym_else_if_clause = 55,
  sym_else_keyword = 56,
  sym_else_clause = 57,
  sym_block = 58,
  sym_while_statement = 59,
  sym_while_keyword = 60,
  sym_for_statement = 61,
  sym_for_keyword = 62,
  sym_for_condition = 63,
  sym_times_keyword = 64,
  sym_action_statement = 65,
  sym_action_type = 66,
  sym_forward_action = 67,
  sym_backwards_action = 68,
  sym_right_action = 69,
  sym_left_action = 70,
  aux_sym_source_file_repeat1 = 71,
  aux_sym_else_if_chain_repeat1 = 72,
};
...
static const char * const ts_symbol_names[] = {
  ...
  [sym_else_if_chain] = "else_if_chain",
  ...
  [aux_sym_else_if_chain_repeat1] = "else_if_chain_repeat1",
};
...
static const TSSymbol ts_symbol_map[] = {
  ...
  [sym_else_if_chain] = sym_else_if_chain,
  ...
  [aux_sym_else_if_chain_repeat1] = aux_sym_else_if_chain_repeat1,
};
...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_program_end] = STATE(66),
    [sym_statement] = STATE(3),
    [sym_empty_statement] = STATE(16),
    [sym_if_statement] = STATE(24),
    [sym_if_keyword] = STATE(42),
    [sym_while_statement] = STATE(24),
    [sym_while_keyword] = STATE(39),
    [sym_for_statement] = STATE(24),
    [sym_for_keyword] = STATE(37),
    [sym_action_statement] = STATE(17),
    [sym_action_type] = STATE(62),
    [sym_forward_action] = STATE(54),
    [sym_backwards_action] = STATE(54),
    [sym_right_action] = STATE(54),
    [sym_left_action] = STATE(54),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [38] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(69),
  [41] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(58),
  [44] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_file_repeat1, 2, 0, 0), SHIFT_REPEAT(51),
  ...
  [66] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 3, 0, 0),
  [68] = {.entry = {.count = 1, .reusable = true}}, SHIFT(32),
  [70] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 3, 0, 0),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_if_chain, 1, 0, 0),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else_if_chain, 1, 0, 0),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_else_if_chain_repeat1, 2, 0, 0),
  [78] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_else_if_chain_repeat1, 2, 0, 0), SHIFT_REPEAT(32),
  [81] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_else_if_chain_repeat1, 2, 0, 0),
  [83] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_statement, 4, 0, 0),
  [85] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_if_statement, 4, 0, 0),
  ...
  [95] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_if_clause, 4, 0, 0),
  [97] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else_if_clause, 4, 0, 0),
  [99] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_empty_statement, 1, 0, 0),
  [101] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_empty_statement, 1, 0, 0),
  [103] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_statement, 1, 0, 0),
  [105] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_statement, 1, 0, 0),
  ...
  [111] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_statement, 3, 0, 0),
  [113] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_for_statement, 3, 0, 0),
  [115] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_statement, 3, 0, 0),
  [117] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_action_statement, 3, 0, 0),
  ...
  [123] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_clause, 2, 0, 0),
  [125] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_else_clause, 2, 0, 0),
  [127] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program_start, 1, 0, 0),
  [129] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_program_start, 1, 0, 0),
  [131] = {.entry = {.count = 1, .reusable = true}}, SHIFT(68),
  [133] = {.entry = {.count = 1, .reusable = true}}, SHIFT(45),
  [135] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_modifier, 2, 0, 0),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition_modifier, 3, 0, 0),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_else_keyword, 1, 0, 0),
  [151] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [153] = {.entry = {.count = 1, .reusable = true}}, SHIFT(61),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [157] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program_end, 1, 0, 0),
  ...
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_keyword, 1, 0, 0),
  [173] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_left_action, 1, 0, 0),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_forward_action, 1, 0, 0),
  [177] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_action_type, 1, 0, 0),
  [179] = {.entry = {.count = 1, .reusable = true}},  ACCEPT_INPUT(),
  [181] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_times_keyword, 1, 0, 0),
  [183] = {.entry = {.count = 1, .reusable = true}}, SHIFT(67),
  [185] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_while_keyword, 1, 0, 0),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_condition, 4, 0, 0),
  ...
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_for_condition, 4, 0, 0),
  [201] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_coin_instance, 1, 0, 0),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_if_keyword, 1, 0, 0),
};
